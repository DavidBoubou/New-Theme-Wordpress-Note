...
class MagazineNP_About
{
	...
	function premium_features()
	{
		...
		$modules = array(
			...
			array(
				'name' => esc_html__('Typography Customization', 'magazinenp'),
			...
			array(
				'name' => esc_html__('Post Layout', 'magazinenp'),
				'desc' => esc_html__('Archive page post layout', 'magazinenp'),
				'url' => '',
			),
			array(
				'name' => esc_html__('Header Layout', 'magazinenp'),
				'desc' => esc_html__('Different type of header', 'magazinenp'),
				'url' => '',
			),
			array(
				'name' => esc_html__('Post Master Widget', 'magazinenp'),
		...
		<div class="mb-about-box pro">
			<div class="mb-about-box-top"><span
				...
				<a class="mb-about-upgrade" target="_blank"
				   href="https://mantrabrain.com/downloads/magazinenp-pro/?ref=themepanel-upgradenow"><?php _e('Upgrade Now &rarr;', 'magazinenp'); ?></a>
			</div>
